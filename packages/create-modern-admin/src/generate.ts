...
const loadCanonicalPrisma = async (): Promise<string> => {
  ...
  const candidates = [
    // workspace dev install (packages/create-modern-admin/dist|src/.. → packages/system-prisma/prisma/…)
    resolve(here(), '..', '..', 'system-prisma', 'prisma', 'modern-admin.prisma'),
    // node_modules install (node_modules/create-modern-admin/dist|src/.. → node_modules/@modern-admin/system-prisma/prisma/…)
    resolve(here(), '..', '..', '@modern-admin', 'system-prisma', 'prisma', 'modern-admin.prisma'),
  ]
