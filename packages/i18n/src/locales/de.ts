...
export const de: LocaleBundle = {
  ...
  dict: {
    ...
    'common:noMatchingRecords': 'Keine Einträge entsprechen Ihren Filtern.',
    ...
    'common:toggleSuggestions': 'Vorschläge ein-/ausblenden',
    ...
    'home:searchResources': 'Ressourcen suchen…',
    'home:noMatchingResources': 'Keine passenden Ressourcen gefunden.',
    'globalSearch:title': 'Globale Suche',
    'globalSearch:description': 'Über alle Ressourcen und Datensätze hinweg suchen.',
    'globalSearch:trigger': 'Suchen…',
    'globalSearch:placeholder': 'Über alle Ressourcen suchen…',
    'globalSearch:hint': 'Tippen, um in allen Ressourcen zu suchen.',
    'globalSearch:noResults': 'Keine passenden Datensätze gefunden.',
    'globalSearch:error': 'Suche fehlgeschlagen. Bitte erneut versuchen.',
    'globalSearch:hotkey': 'Globale Suche öffnen',
    'globalSearch:matchedIn': 'in {field}',
    'globalSearch:recent': 'Letzte Suchen',
    'globalSearch:clearRecent': 'Löschen',
    'globalSearch:showAllIn': 'Alle in {resource} anzeigen',
    ...
    'common:uploadEmptyResponse': 'Server hat kein Upload-Ergebnis zurückgegeben',
    'common:uploadInvalidResponse': 'Ungültige Upload-Antwort',
    'common:uploadNetworkError': 'Netzwerkfehler beim Upload',
    'common:uploadAborted': 'Upload abgebrochen',
    'common:dismiss': 'Schließen',
    'common:openCalendar': 'Kalender öffnen',
    'common:time': 'Uhrzeit',
    'common:downloadFailed': 'Download fehlgeschlagen',
    'common:cannotPreview': 'Für diesen Medientyp ist keine Vorschau verfügbar.',
    'richtext:bold': 'Fett',
    ...
    'dashboard:builder.opMultiply': 'Multiplizieren mit',
    'dashboard:builder.opAdd': 'Addieren',
    'dashboard:builder.opSubtract': 'Subtrahieren',
    'dashboard:builder.format': 'Werteformat',
    'dashboard:builder.formatStyle': 'Stil',
    'dashboard:builder.formatNumber': 'Zahl',
    'dashboard:builder.formatCurrency': 'Währung',
    'dashboard:builder.formatPercent': 'Prozent',
    'dashboard:builder.formatCurrencyCode': 'Währungscode',
    'dashboard:builder.formatDecimals': 'Dezimalstellen',
    'dashboard:builder.formatCompact': 'Kompakte Zahlen (12,5 Tsd.)',
    'dashboard:builder.formatPrefix': 'Präfix',
    'dashboard:builder.formatSuffix': 'Suffix',
    'dashboard:builder.color': 'Reihenfarbe',
    'dashboard:widget.previousSeries': '{label} (Vorperiode)',
    'dashboard:widget.editColors': 'Farben bearbeiten',
    'dashboard:widget.colorsTitle': 'Reihenfarben',
    'dashboard:widget.colorCustom': 'Benutzerdefiniert',
    'dashboard:widget.colorAuto': 'Automatisch',
    'dashboard:widget.colorPick': 'Farbe wählen',
    'dashboard:builder.tabData': 'Daten',
    'dashboard:builder.tabDisplay': 'Darstellung',
    'dashboard:builder.tabFilters': 'Filter',
    'dashboard:builder.filtersEmpty': 'Diese Ressource hat keine filterbaren Felder.',
    ...
    'audit:prevPage': 'Zurück',
    'audit:nextPage': 'Weiter',
    'audit:dateRangePlaceholder': 'Datumsbereich auswählen',
    ...
    'filter:op.co': 'Enthält',
    'filter:op.nco': 'Enthält nicht',
    'filter:op.sw': 'Beginnt mit',
    'filter:op.ew': 'Endet mit',
    'filter:op.eq': 'Ist gleich',
    'filter:op.neq': 'Ist nicht gleich',
    'filter:op.empty': 'Ist leer',
    'filter:op.nempty': 'Ist nicht leer',
    'filter:op.in': 'Ist einer von',
    'filter:op.gt': 'Größer als',
    'filter:op.lt': 'Kleiner als',
    'filter:op.between': 'Zwischen',
    'filter:searchValues': 'In Liste suchen…',
    'filter:selectAll': 'Alle auswählen',
    'filter:noValues': 'Keine Werte gefunden',
    'common:newRecord': 'Neu: {name}',
    'common:editRecord': '{name} #{id} bearbeiten',
    'common:themeLight': 'Hell',
    'common:themeDark': 'Dunkel',
    'common:themeSystem': 'System',
    'common:ok': 'OK',
    'common:select': 'Auswählen…',
    'common:removeItem': '{title} entfernen',
    'common:nSelectedAddMore': '{count} ausgewählt — weitere hinzufügen',
    'common:pickRecords': 'Datensätze auswählen',
    'common:managePickRecords': 'Auswahl verwalten ({count})',
    'common:pickRecordsFrom': 'Aus {name} auswählen',
    'common:draftRestored': 'Nicht gespeicherter Entwurf wiederhergestellt',
    ...
    'aiFill:errorNoFields': 'Diese Ressource hat keine KI-ausfüllbaren Felder.',
    'aiFill:errorGeneric': 'KI-Ausfüllen fehlgeschlagen: {message}',
    'aiFill:noValues': 'Die KI konnte aus diesem Bild keine Werte extrahieren.',
    'aiFill:applied': 'KI hat {count} Feld(er) ausgefüllt. Unten rückgängig machen.',
    'wizard:stepOf': 'Schritt {current} von {total}',
    'wizard:products.step1': 'Grundinfo',
    'wizard:products.step2': 'Preisgestaltung',
    'wizard:products.step3': 'Medien & Tags',
    'common:invalidValue': 'Ungültiger Wert',
    ...
    'common:sidebarTitle': 'Seitenleiste',
    'common:sidebarNavigation': 'Navigationsmenü',
    'cache:title': 'Cache',
    'cache:description': 'Cache-Zustand und Ressourcenleistung auf dieser Replik.',
    'cache:load.error': 'Cache-Metriken konnten nicht geladen werden',
    'cache:load.retry': 'Erneut versuchen',
    'cache:reset.action': 'Metriken zurücksetzen',
    'cache:reset.loading': 'Cache-Metriken werden zurückgesetzt…',
    'cache:reset.success': 'Cache-Metriken zurückgesetzt',
    'cache:reset.error': 'Cache-Metriken konnten nicht zurückgesetzt werden',
    'cache:metric.hitRate': 'Trefferquote',
    'cache:metric.requests': 'Cache-Lesevorgänge',
    'cache:metric.avgCompute': 'Mittlere Berechnung',
    ...
    'cache:invalidate.success': 'Ressourcen-Cache invalidiert',
    'cache:invalidate.error': 'Ressourcen-Cache konnte nicht invalidiert werden',
    'cache:table.title': 'Metriken nach Namensraum',
    'cache:table.empty': 'Noch keine Cache-Aktivität erfasst.',
    'cache:instance': 'Replik {id}',
    'cache:table.namespace': 'Namensraum',
    'cache:table.resource': 'Ressource',
    'cache:table.hits': 'Treffer',
    'cache:table.misses': 'Fehltreffer',
    'cache:table.computes': 'Berechnungen',
    'cache:table.coalesced': 'Gebündelt',
    ...
    'mediaGeneration:settings.disabled': 'Deaktiviert',
    'mediaGeneration:settings.configured': 'API-Schlüssel konfiguriert',
    'mediaGeneration:settings.apiKeyRequired': 'API-Schlüssel erforderlich',
    'mediaGeneration:settings.enableLabel': 'Mediengenerierung aktivieren',
    ...
    'mediaGeneration:again': 'Erneut generieren',
    'mediaGeneration:download': 'Herunterladen',
    'mediaGeneration:task.submitted': 'Mediengenerierung gestartet',
    'mediaGeneration:status.pending': 'In Warteschlange',
    'mediaGeneration:status.running': 'Wird generiert',
    'mediaGeneration:status.succeeded': 'Bereit',
    'mediaGeneration:status.failed': 'Fehlgeschlagen',
    ...
    'mediaGeneration:apply.success': 'Generiertes Medium angewendet',
    'mediaGeneration:error.modelRequired': 'Generierungsmodell auswählen',
    'mediaGeneration:error.recordRequired': 'Diese Aktion benötigt einen Datensatz.',
  },
}
